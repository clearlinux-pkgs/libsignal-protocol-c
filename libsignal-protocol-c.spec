...
Source0  : https://github.com/signalapp/libsignal-protocol-c/archive/v2.3.2.tar.gz
...
%prep
%setup -q -n libsignal-protocol-c-2.3.2
cd %{_builddir}/libsignal-protocol-c-2.3.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1580758754
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/libsignal-protocol-c-2.3.2/LICENSE %{buildroot}/usr/share/package-licenses/libsignal-protocol-c/a6adc13d0c809ab8cb68e6e3b6eb7571bd0e2920
pushd clr-build
%make_install
popd
...
/usr/lib64/libsignal-protocol-c.so.2.3.2
